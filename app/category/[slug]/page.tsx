...
export default async function CategoryArchivePage({
  ...
  if ((slug === "province" || slug === "pradesh") && currentProvince) {
    articles = await getArticlesByProvince(currentProvince, 12);
  } else {
    const data = await getArticlesByCategory(slug, 12);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 font-mukta">
      ...
      {/* Category Title Header & Province Pills if in Province Category */}
          ...
          {articles.length > 0 ? (
            ...
            <div className="py-16 text-center bg-white rounded-md border border-slate-200 p-8">
              <p className="text-base font-bold text-slate-700">
                यस प्रदेश/विधामा सामग्रीहरू चाँडै प्रकाशित गरिनेछ।
              </p>
            </div>
          )}
        </div>
